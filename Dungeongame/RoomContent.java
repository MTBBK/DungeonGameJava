...
this.name=name; this.health=health; this.damage=damage; this.hasSpecialSpecial=hasSpecialSpecial;}
...
System.out.println("");
System.out.println("                \\||/\n                |  @___oo\n      /\\  /\\   / (__,,,,|\n     ) /^\\) ^\\/ _)\n     )   /^\\/   _)\n     )   _ /  / _)\n /\\  )/\\/ ||  | )_)\n<  >      |(,,) )__)\n ||      /    \\)___)\n | \\____(      )___) )___\n  \\______(_______;;; __;;;");//I used these textarts for player to see their oponents directly like undertale or pokemon
